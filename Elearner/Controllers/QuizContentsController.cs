...
namespace SQLElearner.Controllers
{
    public class QuizContentsController : Controller
    {
        ...
        {
            var quizContents = db.QuizContents.Include(q => q.Question).Include(q => q.QuestionAnswer).Include(q => q.Quiz);
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.QuizId = new SelectList(db.Quizes, "QuizId", "QuizName");
            return View();
        }
        ...
        public async Task<ActionResult> Create([Bind(Include = "QuizContentId,QuizId,QuestionId,QuestionAnswerId")] QuizContent quizContent)
        {
            ...
            ViewBag.QuizId = new SelectList(db.Quizes, "QuizId", "QuizName", quizContent.QuizId);
            return View(quizContent);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "QuizContentId,QuizId,QuestionId,QuestionAnswerId")] QuizContent quizContent)
        {
            if (ModelState.IsValid)
            {
